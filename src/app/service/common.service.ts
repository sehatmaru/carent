...
export class CommonService {
  ...
  get(url: string, params?: any, reqOpts?: any): boolean | Observable<any> {
    if (this.checkConnection()) {
      ...
      return this.http.get<any>(environment.baseUrl + url, reqOpts).pipe(
  ...
  post(
    ...
    if (this.checkConnection()) {
      ...
      return this.http.post<any>(environment.baseUrl + url, body, reqOpts).pipe(
  ...
  patch(
    ...
    if (this.checkConnection()) {
      ...
      return this.http
        .patch<any>(environment.baseUrl + url, body, reqOpts)
        .pipe(
          timeout(reqTimeout ? reqTimeout : 300000),
          retry(maxRetry ? maxRetry : 0),
          catchError((error: any, caught: Observable<HttpEvent<any>>) => {
  ...
  put(url: string, body: any, reqOpts?: any): boolean | Observable<any> {
    if (this.checkConnection()) {
      ...
      return this.http.put<any>(environment.baseUrl + url, body, reqOpts).pipe(
        catchError((error: any, caught: Observable<HttpEvent<any>>) => {
          this.handlerResponseService.failedResponse(error)
          throw error
        })
  ...
  delete(
    ...
    if (this.checkConnection()) {
      ...
      return this.http.delete<any>(environment.baseUrl + url, reqOpts).pipe(
        catchError((error: any, caught: Observable<HttpEvent<any>>) => {
          this.handlerResponseService.failedResponse(error)
          throw error
        })
